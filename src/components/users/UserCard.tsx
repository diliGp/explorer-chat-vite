    ...
    return (
        ...
        >
            ...
            <div className="flex-1 min-w-0">
                <p
                    className={`text-sm truncate ${hasUnread ? 'font-bold text-[var(--text-primary)]' : 'font-semibold text-[var(--text-primary)]'}`}
                >
                    {user.name}
                </p>
                <p
                    className={`text-xs truncate ${hasUnread ? 'text-[var(--text-primary)]' : 'text-[var(--text-muted)]'}`}
                >
                    {subtitle}
                </p>
            </div>
